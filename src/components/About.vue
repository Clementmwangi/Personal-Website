<template>
    ...
    id="about">
        <div class="w-full px-5 sm:px-8 md:px-12 lg:px-8 max-w-5xl lg:max-w-7xl 
        mx-auto relative z-10">
            <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 items-center">
                <div class="lg:h-full flex justify-center lg:justify-start order-2 
                lg:order-1 ">
                    <div class="relative w-full max-w-md">
                        <div data-aos="zoom-in"
                        class="relative bg-linear-to-br from-gray-800/60 p-6
                        to-blue-900/40 rounded-3xl backdrop-blur-sm border
                        border-blue-500/30 shadow-2xl">
                            ...
                            bg-linear-to-r from-blue-500 to-cyan-500 rounded-2xl px-6 py-3 
                            border border-blue-400/40 shadow-xl" data-aos="fade-up"
                            data-aos-delay="600">
                                <div class="text-center text-xl text-white
                                font-bold ">1+ Years Experience</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col justify-center order-1 lg:order-2">
                    <div class="text-center lg:text-left" data-aos="fade-left" >
                        ...
                        <p class="text-blue-400 font-medium text-lg md:text-xl mt-4" data-aos="fade-left"
                        data-aos-delay="100">
                            Full-Stack Developer and IT 
                        </p>
                    </div>
                    ...
                    <div class="flex gap-4 pt-8 flex-col sm:flex-row" data-aos="fade-up"
                    data-aos-delay="400">
                        <button v-for="button in ctaButtons" :key="button.id" class="px-8 py-3 rounded-xl
    ...
    const skills = [
        {
            ...
            title: 'Front-end',
            desc: "Vue js, Vanila css, Javascript,Tailwind CSS, HTML",
        },
        {
            id: 2,
            icon: ServerIcon,
        ...
        },
        {
            ...
            iconColor: "text-cyan-400",
            title: 'Design',
            desc: "Responsive design, UI/UX Design",
        }
    ]
