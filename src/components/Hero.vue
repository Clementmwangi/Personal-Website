        ...
        <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 items-center">
            <div class="flex flex-col md:mt-0 mt-20 justify-center">
                ...
                lg:mx-0" data-aos="fade-up" data-aos-delay="200">
                    <button class="px-8 md:px-10 py-4 rounded-xl relative group w-full sm:w-max flex 
                    justify-center overflow-hidden bg-linear-to-r from-blue-600 to-cyan-600 hover:from-blue-500
                    hover:to-cyan-500 transition-all duration-300">
                        <span class="relative flex items-center justify-center text-white 
                        font-semibold text-lg ">Contact me
                    <ArrowRightIcon class="w-5 h-5 ml-2  transition-transform 
                        group-hover:translate-x-1" />
                    </span>   
                    </button>
                    <button class="border-2 border-blue-400 px-8 md:px-10 py-4 rounded-xl
                    relative group w-full sm:w-max flex justify-center hover:bg-blue-400/10
                    transition-all duration-300 ">
                        <div class="flex items-center justify-center relative">
                            <ArrowDownTrayIcon 
                            class="w-5 h-5 text-blue-400 group-hover:translate-y-1 trasition-transform"/>
                ...
                data-aos="fade-up" data-aos-delay="400">
                    <div class="text-center ">
                     ...
                     <div class="text-center ">
                        ...
                        <div class="text-sm text-blue-200">Clients</div>
                    </div>
                </div>
            </div>
            <!--image-->
            <div class="lg:h-full flex justify-center lg:justify-end">
                <div class="relative w-full max-w-md lg:max-w-lg">
                    ...
                    <div class="absolute -top-2 -right-4 w-10 h-10 bg-blue-400
                    rounded-full blur-sm opacity-6 animate-pulse"></div>
